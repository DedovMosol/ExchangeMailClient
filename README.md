...
- **Экран персонализации** — настройки внешнего вида вынесены в отдельный экран (язык, шрифты, темы, анимации)
- **Улучшенные диалоги** — компактный дизайн с анимацией появления
- **Исправления** — экспорт контактов, тестовое письмо при верификации
