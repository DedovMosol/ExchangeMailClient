...
- **Группы контактов** — организация контактов по папкам с фильтрацией
- **Реальный прогресс удаления** — при очистке корзины показывается X / Y писем
- **Цвет аватара** — аватар пользователя меняется вместе с цветовой темой
